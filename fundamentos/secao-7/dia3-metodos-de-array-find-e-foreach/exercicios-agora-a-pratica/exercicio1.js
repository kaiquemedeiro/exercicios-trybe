...
//   console.log((countries));
  ...
  countries.forEach((country) => {
    ...
    newArrayCountry.push(ObjCountry);
  });
  ...
  countries.forEach((country) => {
    const CountryFormated = buildString(countries, country.name, country.capital, country.currencies[0].code, country.currencies[0].name);

    const fomatedFinal = CountryFormated.replace(/,/g, ' - ');

    console.log(fomatedFinal);
  });
